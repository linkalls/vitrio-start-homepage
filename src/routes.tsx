        ...
        >
          <DocArticle>
            <section id="why">
              ...
              <p class="mt-3 text-zinc-300 leading-7">
                vitrio-start は元々 <span class="font-mono text-zinc-200">routes.tsx</span> にルート配列を手書きするスタイルだった。
                これは「全部見える」強さがある一方で、Next.js / TanStack Start から来た人にとって入口が遠い。
              </p>
              <p class="mt-3 text-zinc-300 leading-7">
                そこで file router を入れた。と言っても魔法は増やさない。
                <strong>ファイルをスキャンして defineRoute 配列を生成するだけ</strong>。
                生成物が TS なので、困ったら読めるし、デバッグも楽なのだ。
              </p>
            </section>
            ...
            <section id="convention">
              ...
              <div class="mt-4 rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 text-sm text-zinc-400">
                <ul class="list-disc space-y-1 pl-5">
                  <li><span class="font-mono text-zinc-200">src/pages/**/page.tsx</span> をページとして扱う</li>
                  <li>フォルダ名がそのままパスになる（<span class="font-mono">about/page.tsx</span> → <span class="font-mono">/about</span>）</li>
                  <li>アンダースコアで始まるフォルダ（<span class="font-mono">_internal</span>）は無視</li>
                </ul>
              </div>
            </section>
            ...
            <section id="dynamic">
              ...
              <div class="mt-4 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950/40">
                <div class="grid grid-cols-1 sm:grid-cols-3">
                  ...
                  <div class="p-4 text-sm text-zinc-400 border-t border-zinc-800"><span class="font-mono">users/[id]/page.tsx</span></div>
                  <div class="p-4 text-sm text-zinc-400 border-t border-zinc-800 sm:border-l"><span class="font-mono">/users/:id</span></div>
                  <div class="p-4 text-sm text-zinc-400 border-t border-zinc-800 sm:border-l">params.id で受け取る</div>

                  <div class="p-4 text-sm text-zinc-400 border-t border-zinc-800"><span class="font-mono">blog/[...slug]/page.tsx</span></div>
                  <div class="p-4 text-sm text-zinc-400 border-t border-zinc-800 sm:border-l"><span class="font-mono">/blog/*</span></div>
            ...
            <section id="exports">
              <h2>Page exports</h2>
              <p class="mt-3 text-zinc-300 leading-7">
                <span class="font-mono text-zinc-200">page.tsx</span> は「ルート定義の部品」だと思うと理解しやすい。
                Next の page component に loader/action が足せる感じ。
              </p>
              <CodeBlock
...
export default function Page({ data, csrfToken }) {
  return <div>User: {data.user.name}</div>
              ...
              <div class="mt-4 rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 text-sm text-zinc-400">
                ...
                <ul class="mt-2 list-disc space-y-1 pl-5">
                  <li><span class="font-mono text-zinc-200">default</span> or <span class="font-mono text-zinc-200">component</span></li>
                  <li><span class="font-mono text-zinc-200">loader</span></li>
                  <li><span class="font-mono text-zinc-200">action</span></li>
                  <li><span class="font-mono text-zinc-200">client</span></li>
                </ul>
              </div>
            </section>
            ...
            <section id="precedence">
              ...
              <p class="mt-3 text-zinc-300 leading-7">
                vitrio-start は <strong>fsRoutes（file router）→ manualRoutes（手書き）</strong> の順に合成している。
                つまり「同じパスが両方にあるなら file router が勝つ」。
                手書き側はテスト用ルートやデモ、例外処理の置き場として使う想定。
              </p>
            </section>
          </DocArticle>
        </RefChrome>
        ...
        <RefChrome path="/reference/faq" title="FAQ" subtitle="ハマりどころを雑に全部メモる場所。" toc={toc}>
          <DocArticle>
            <section id="islands">
              ...
              <p class="mt-3 text-zinc-300 leading-7">
                vitrio-start の Islands は、いわゆる React の hydration みたいに DOM を再利用して差分だけ当てるやつではないのだ。
                いまの実装は「<span class="font-mono text-zinc-200">data-island</span> の箱に対して Vitrio を mount する」＝
                <strong>mount/replace</strong>。
              </p>
              <div class="mt-6 rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4">
            ...
            <section id="use-client">
              ...
              <p class="mt-3 text-zinc-300 leading-7">
                vitrio-start の <span class="font-mono text-zinc-200">client: true</span> は、Next.js の "use client" と似てるけど単位が違う。
                「このルートだけ client entry を読む」= まず<strong>ルート単位</strong>。
                その上で islands を使うと「ページの一部だけ」を動かせる。
              </p>
              <div class="mt-6 rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 text-sm text-zinc-400">
                <div class="font-semibold text-zinc-200">覚え方</div>
                <ul class="mt-2 list-disc space-y-1 pl-5">
                  <li><span class="font-mono text-zinc-200">client: true</span> = "このページは JS が必要"</li>
                  <li><span class="font-mono text-zinc-200">island()</span> = "この部分は TSX で動かす"</li>
                  <li><span class="font-mono text-zinc-200">*.client.tsx</span> = "この部品は client 側で使う"</li>
                </ul>
              </div>
            </section>
            ...
            <section id="naming">
              ...
              <p class="mt-3 text-zinc-300 leading-7">
                production build だと関数名が潰れるので、<span class="font-mono text-zinc-200">function.name</span> を信じると事故る。
                だから vitrio-start は <strong>ファイル名 stem</strong>（例: <span class="font-mono">Counter.client.tsx</span> → <span class="font-mono">"Counter"</span>）を島名の基本にしてる。
              </p>
              <div class="mt-4 rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 text-sm text-zinc-400">
                ...
                <ul class="mt-2 list-disc space-y-1 pl-5">
                  ...
                  <li>島名は file stem</li>
                  <li>どうしても変えたい時だけ <span class="font-mono text-zinc-200">export const ISLAND_NAME</span></li>
                </ul>
              </div>
            </section>
            ...
            <section id="assets">
              ...
              <p class="mt-3 text-zinc-300 leading-7">
                Workers は HTML は毎回SSRできるけど、静的アセットまで Worker で捌くとコストも遅延も読めなくなる。
                なので <span class="font-mono text-zinc-200">[assets]</span> + <span class="font-mono text-zinc-200">run_worker_first=false</span> を基本にする。
              </p>
              <div class="mt-4 rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 text-sm text-zinc-400">
                <div class="font-semibold text-zinc-200">チェックリスト</div>
                <ul class="mt-2 list-disc space-y-1 pl-5">
                  <li>CSS/JS のパスが <span class="font-mono">/assets/...</span> で揃ってる？</li>
                  <li>キャッシュで「直したのに反映されない」時はファイル名ハッシュ化 or purge</li>
                  <li>Worker側で assets を触る設計にしてない？（触るなら run_worker_first=true が必要）</li>
                </ul>
              </div>
            </section>
            ...
            <section id="wrangler">
              ...
              <p class="mt-3 text-zinc-300 leading-7">
                ローカルは <span class="font-mono text-zinc-200">wrangler login</span> で通るけど、CI は API Token が必要。
                さらに「whoami は通るのに deploy/delete で memberships が死ぬ」系は <span class="font-mono">account_id</span> 明示で回避できることがある。
              </p>
            </section>
            ...
            <section id="shiki">
              <h2>Shiki / Workers</h2>
              <p class="mt-3 text-zinc-300 leading-7">
                Workers runtime で <span class="font-mono text-zinc-200">import('shiki')</span> すると落ちることがある。
                だからこのサイトは Node で <strong>事前に HTML を生成</strong>して <span class="font-mono">src/server/highlight.ts</span> に埋め込んでる。
              </p>
            </section>
            ...
            <section id="overflow">
              ...
              <p class="mt-3 text-zinc-300 leading-7">
                2カラムの中にコードブロックがあると、親が <span class="font-mono text-zinc-200">min-w-0</span> じゃないせいで全体が横スクロールになる。
                なので grid の子には <span class="font-mono text-zinc-200">min-w-0</span> を付ける、CodeBlock は横スクロールを内側に閉じ込める。
              </p>
            </section>
            ...
            <section id="migrate">
              ...
              <div class="mt-6 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950/40">
                <div class="grid grid-cols-1 sm:grid-cols-3">
                  ...
                  <div class="p-4 text-sm text-zinc-400 border-t border-zinc-800 sm:border-l"><span class="font-mono text-zinc-200">loader()</span></div>
                  ...
                  <div class="p-4 text-sm text-zinc-400 border-t border-zinc-800 sm:border-l"><span class="font-mono text-zinc-200">action()</span> + PRG</div>
                  ...
                  <div class="p-4 text-sm text-zinc-400 border-t border-zinc-800 sm:border-l"><span class="font-mono text-zinc-200">client: true</span> + <span class="font-mono text-zinc-200">island()</span> + <span class="font-mono text-zinc-200">*.client.tsx</span></div>
                </div>
              </div>
            </section>
          </DocArticle>
